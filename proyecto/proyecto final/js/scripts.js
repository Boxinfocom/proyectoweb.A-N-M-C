        ...
        const productosDisponibles = [
            { codigo: 'PROD-001', nombre: 'Empanada de carne', precio: 2.5000 },
            { codigo: 'PROD-002', nombre: 'Empanada de pollo', precio: 2.5000 },
            { codigo: 'PROD-003', nombre: 'Empanada mixta', precio: 2.5000 },
            { codigo: 'PROD-004', nombre: 'Empanada vegana', precio: 3.200 }
        ];
        ...
        function cargarProductosCotizacion() {
            ...
            if (!container) return;
            container.innerHTML = 'cotizacion';
            ...
            productosDisponibles.forEach((producto, index) => {
                ...
                row.innerHTML = `
                    <div class="form-group" style="margin:0;">
                        <img src="imagenes/productos/${producto.codigo.toLowerCase()}.jpg"
                             alt="${producto.nombre}" 
